...
import { GitBranch, Github, AlertCircle, Link2, List, Users, Search, X, HardDrive, Check } from 'lucide-react';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {inputMode === 'browse' && (
        <div className="space-y-4">
          {/* Owner Search Input */}
          <div className='py-0'>
            {/* <div className='w-full h-[2px] bg-gray-200 rounded-full mb-6' /> */}
            <label className="block text-md font-medium text-gray-700 mb-2 ml-1">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent ${
                    ownerSearchError ? 'border-red-300' : 'border-gray-400'
                  }`}
                />
              </div>
              <button
            ...
            <div className='w-full h-[2px] bg-gray-200 rounded-full mt-8' />
            {ownerSearchError && (
      ...
      {inputMode === 'url' && (
        <div>
          <label htmlFor="repo-url" className="block text-md font-medium text-gray-700 mb-2 ml-1">
            Repository URL
          </label>
          <input
            id="repo-url"
            ...
            className={`w-full px-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all ${
              validationError ? 'border-red-300' : 'border-gray-400'
            }`}
            disabled={isLoading}
          />
          {validationError && (
